...
import sys
sys.path.append("..")
from vstim import chirp_v2, ChirpParamsV2
...
if __name__ == "__main__":
    ...
    time.sleep(1) # wait 5 sec before proceeding
    # start session; generate TTL pulses from channel 1
    chirp_v2(win, exp_handler, p, dlp=dlp, code_on=b'1', code_off=b'Q')

    time.sleep(1) # wait 10 sec after the session is over

...
if __name__ == "__main__":
    ...
    # black -> black
    reset_screen3(win_lum, start_color=[-1,-1,-1], end_color=[-1, -1, -1], ramp_time=3, hold_time=0, framerate=fr, stim_size=s1)
    for rep in range(repeats):
        ...
        if stop_loop: break
        # black -> white
        reset_screen3(win_lum, start_color=[-1,-1,-1], end_color=[1, 1, 1], ramp_time=2, hold_time=2, framerate=fr, stim_size=s1)

classdef VS_linearlyMovingBall < VStim
    ...
    methods
        function obj=run(obj)
            ...
            D0=obj.ballSize*10; %half a ball on each side
            r0=D0/2;
            ...
            maxFrames=ceil(D0./min(obj.speed)/obj.ifi(obj.selectedScreen));
                ...
                for j=1:nOffsets
                    for k=1:obj.numberOfDirections
                        for l=1:nBallSizes
                            ...
                            t=(0:obj.ifi(obj.selectedScreen):movementDuration)';
            ...
            for i=1:obj.nTotTrials
                ...
                t=(1:obj.nFrames(pTmpSpeed,pTmpOffset,pTmpPhi))*obj.ifi(obj.selectedScreen)+GetSecs;
                ...
                for j=1:obj.nFrames(pTmpSpeed,pTmpOffset,pTmpPhi)
                    ...
                    Screen('FillOval',obj.PTB_win(obj.selectedScreen),obj.ballLuminosity,ballCoordinates);
                    ...
                    [obj.flip(i,j),obj.stim(i,j),obj.flipEnd(i,j),obj.miss(i,j)]=Screen('Flip',obj.PTB_win(obj.selectedScreen),t(j));
        ...
        function outStats=getLastStimStatistics(obj,hFigure)
           outStats.props=obj.getProperties;
            ...
            ylabel('\Delta(Flip)');
            xlabel('Time [ms]');
            line([obj.ifi(obj.selectedScreen) obj.ifi(obj.selectedScreen)],ylim,'color','k','LineStyle','--');
